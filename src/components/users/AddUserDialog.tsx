...
import { defaultPermissions, handlePermissionChange, PermissionsSection } from './PermissionsSection';
...
export default function AddNewUser({ isAddDialogOpen, setIsAddDialogOpen }) {
    ...
    const handleAddUser = (e: any) => {
        ...
        post(route('users.store'), {
            ...
            onSuccess: () => reset('name', 'email', 'password', 'country', 'role', 'currency')
        });
    };
                ...
                <div className="grid gap-6 py-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <PermissionsSection
                            ...
                            onChange={(permissionKey: keyof UserPermissions, checked: boolean) => handlePermissionChange(permissionKey, checked, false)}
                        />
                    </div>
                </div>
                <DialogFooter>
