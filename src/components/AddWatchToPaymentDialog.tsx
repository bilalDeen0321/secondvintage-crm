...
const AddWatchToPaymentDialog = ({ open, onOpenChange, onAddWatches, existingWatches }: AddWatchToPaymentDialogProps) => {
  ...
  const filteredWatches = availableWatches.filter(watch =>
    watch.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
    watch.brand.toLowerCase().includes(searchTerm.toLowerCase()) ||
    watch.seller.toLowerCase().includes(searchTerm.toLowerCase()) ||
    (watch.sku && watch.sku.toLowerCase().includes(searchTerm.toLowerCase()))
  );
                  ...
                  >
                    <TableCell onClick={(e) => e.stopPropagation()}>
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => handleWatchSelect(watch.id, checked as boolean)}
                      />
                    </TableCell>
                    <TableCell>
                      <img 
                    ...
                    <TableCell className="text-right">
                      <div>
                        ...
                        <div className="text-xs text-muted-foreground">
                          ₫{convertToVND(watch.price).toLocaleString()}
                        </div>
                      </div>
                    </TableCell>
                  </TableRow>
