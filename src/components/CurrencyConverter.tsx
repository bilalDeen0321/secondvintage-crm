...
const CurrencyConverter = ({ euroValue, onEuroChange }: CurrencyConverterProps) => {
  ...
  useEffect(() => {
    if (euroValue && !isNaN(parseFloat(euroValue))) {
      const converted = parseFloat(euroValue) * exchangeRates[selectedCurrency];
  ...
  const handleOtherValueChange = (value: string) => {
    ...
    if (value && !isNaN(parseFloat(value))) {
      const euroEquivalent = parseFloat(value) / exchangeRates[selectedCurrency];
