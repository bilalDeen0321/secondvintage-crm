  ...
  const [invoices] = useState<Invoice[]>([
    {
      ...
      dueDate: '2024-06-15',
      items: [
        { description: 'Commission - Vintage Rolex Submariner Sale', quantity: 1, price: 12500 }
      ]
    },
    {
      id: 'INV-002',
      ...
      dueDate: '2024-07-01',
      items: [
        { description: 'Commission - Omega Speedmaster Professional', quantity: 1, price: 8900 }
      ]
    },
    {
      id: 'INV-003',
      ...
      dueDate: '2024-05-20',
      items: [
        { description: 'Commission - Patek Philippe Calatrava', quantity: 1, price: 15800 }
      ]
    },
  ]);
      ...
      <div className="p-6 space-y-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground">Manage agent invoices and payments</p>
          </div>
          <Dialog>
            ...
            <DialogContent className="max-w-2xl">
              <DialogHeader>
                ...
                <DialogDescription>Generate a new invoice for an agent.</DialogDescription>
              </DialogHeader>
                ...
                <div className="col-span-4">
                  ...
                  <div className="mt-2 space-y-2">
                    <div className="grid grid-cols-12 gap-2">
                      ...
                      <Input placeholder="Price" type="number" className="col-span-3" />
                      <Button size="sm" className="col-span-1">+</Button>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Manage all agent invoices</CardDescription>
          </CardHeader>
          <CardContent>
                  ...
                  <TableRow key={invoice.id}>
                    ...
                    <TableCell>
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">{invoice.agentEmail}</div>
                      </div>
                    </TableCell>
