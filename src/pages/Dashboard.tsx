...
const Dashboard = () => {
  ...
  const topBrandsWithProfit = [
    { brand: 'Rolex', sales: 15, revenue: 285000, profit: 125000, avgProfit: 8333 },
    { brand: 'Omega', sales: 12, revenue: 68000, profit: 32000, avgProfit: 2667 },
    { brand: 'Breitling', sales: 8, revenue: 58000, profit: 28000, avgProfit: 3500 },
    { brand: 'TAG Heuer', sales: 7, revenue: 42000, profit: 18000, avgProfit: 2571 },
    { brand: 'IWC', sales: 5, revenue: 45000, profit: 22000, avgProfit: 4400 },
  ];
      ...
      <div className="p-8">
        <div className="mb-8 flex justify-between items-start">
          <div>
            ...
            <p className="text-slate-600 mt-1">Welcome to Second Vintage CRM</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="border-blue-200 bg-gradient-to-br from-blue-50 to-indigo-50">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-blue-900">€318,000</div>
              <p className="text-xs text-blue-600 mt-1">6 months total</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-green-200 bg-gradient-to-br from-green-50 to-emerald-50">
            ...
            <CardContent>
              ...
              <p className="text-xs text-green-600 mt-1">127 watches</p>
            </CardContent>
          </Card>

          <Card className="border-amber-200 bg-gradient-to-br from-amber-50 to-yellow-50">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-amber-800">Denmark Inventory</CardTitle>
              <Package className="h-5 w-5 text-amber-600" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-amber-900">€850K</div>
              <p className="text-xs text-amber-600 mt-1">89 watches</p>
            </CardContent>
          </Card>

          <Card className="border-purple-200 bg-gradient-to-br from-purple-50 to-violet-50">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-purple-800">External Inventory</CardTitle>
              <Package className="h-5 w-5 text-purple-600" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-purple-900">€350K</div>
              <p className="text-xs text-purple-600 mt-1">38 watches</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-slate-600">Total Watches</p>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-slate-600">Listed</p>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-slate-600">Sold This Month</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Watch Inventory Brand Distribution</CardTitle>
              <CardDescription>Distribution of watches by brand</CardDescription>
            </CardHeader>
            <CardContent>
              <ChartContainer config={chartConfig}>
                <ResponsiveContainer width="100%" height={300}>
                  <PieChart>
                    <Pie
                      data={watchInventoryBrandDistribution}
                      cx="50%"
                      cy="50%"
                      labelLine={false}
                      ...
                      dataKey="count"
                    >
                      {watchInventoryBrandDistribution.map((entry, index) => (
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Monthly watch sales volume and value</CardDescription>
            </CardHeader>
            <CardContent>
              <ChartContainer config={chartConfig}>
                <ResponsiveContainer width="100%" height={300}>
                  <ComposedChart data={watchesSoldPerMonth}>
                        ...
                        if (active && payload && payload.length) {
                          return (
                            <div className="bg-white p-3 border border-slate-200 rounded-lg shadow-lg">
                              ...
                              {payload.map((entry, index) => (
                                <p key={index} style={{ color: entry.color }}>
                                  {entry.name === 'watches' ? `Watches: ${entry.value}` : `Value: €${entry.value?.toLocaleString()}`}
                                </p>
                              ))}
                            </div>
                          );
                    ...
                    />
                    <Bar yAxisId="left" dataKey="watches" fill="#3b82f6" />
          ...
          <div className="lg:col-span-2 grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Sales performance and profit by brand</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  {topBrandsWithProfit.map((brand, index) => (
                    <div key={brand.brand} className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                      <div className="flex items-center gap-3">
                        <span className="text-sm font-medium text-slate-600">#{index + 1}</span>
                        <div>
                          <p className="font-medium text-slate-900">{brand.brand}</p>
                          <p className="text-sm text-slate-600">{brand.sales} sales</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <div className="font-bold text-green-600">€{brand.profit.toLocaleString()}</div>
                        <div className="text-xs text-slate-500">€{brand.avgProfit.toLocaleString()} avg</div>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Countries ranked by total profit</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  {globalSalesData.slice(0, 5).map((country, index) => (
                    <div key={country.country} className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-600">{country.sales} sales</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <div className="font-bold text-green-600">€{country.profit.toLocaleString()}</div>
                        <div className="text-xs text-slate-500">€{country.value.toLocaleString()} revenue</div>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Sales across different platforms</CardDescription>
            </CardHeader>
            <CardContent>
              <ChartContainer config={chartConfig}>
                <ResponsiveContainer width="100%" height={300}>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4 p-3 bg-slate-50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="font-medium text-slate-900">New watch added: Rolex Submariner</p>
            ...
            <div className="flex items-center gap-4 p-3 bg-slate-50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="font-medium text-slate-900">Watch listed on Catawiki: Omega Speedmaster</p>
            ...
            <div className="flex items-center gap-4 p-3 bg-amber-50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="font-medium text-slate-900">Sale completed: TAG Heuer Monaco - Sold for €12,500</p>
            ...
            <div className="flex items-center gap-4 p-3 bg-slate-50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="font-medium text-slate-900">Price updated: Breitling Navitimer - Reduced to €8,900</p>
            ...
            <div className="flex items-center gap-4 p-3 bg-slate-50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="font-medium text-slate-900">Watch serviced: IWC Pilot's Watch - Service completed</p>
