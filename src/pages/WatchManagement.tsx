...
If you have any questions, feel free to contact me after the auction ends.`,
      images: [
        { id: '1', url: '/lovable-uploads/16448c53-9684-40db-9ba2-cc8db08e871c.png', useForAI: true },
        { id: '2', url: '/lovable-uploads/a6232645-6dfc-4c8c-a163-63a08b5a152f.png', useForAI: false },
        { id: '3', url: '/lovable-uploads/7bfeae47-b926-4feb-9e5e-dc722793f8b1.png', useForAI: false },
        { id: '4', url: '/lovable-uploads/c5705a12-d674-4b2c-93d3-566cbb3757fa.png', useForAI: false },
        { id: '5', url: '/lovable-uploads/7130fbd8-0c96-4588-a7a8-c2ba32b3a07f.png', useForAI: false },
        { id: '6', url: '/lovable-uploads/00f3a5e1-e3e7-43d4-8ad4-841f26b8b622.png', useForAI: false }
      ]
    },
    {
      id: '2',
      ...
      images: [
        ...
        { id: '1a', url: '/lovable-uploads/c9668ac2-5bda-49b2-9679-1759280598e1.png', useForAI: true },
        { id: '1b', url: '/lovable-uploads/8a246750-c18b-4b1c-b6af-25185e84d3d7.png', useForAI: false },
        { id: '1c', url: '/lovable-uploads/5557d546-574f-45fb-bd5a-014ec53e5792.png', useForAI: false },
        { id: '1d', url: '/lovable-uploads/42d61632-8522-4f3e-9f7f-712379b47422.png', useForAI: true },
        { id: '1e', url: '/lovable-uploads/0884f9b0-c02c-4735-9af7-ebe16f554fe8.png', useForAI: false },
        { id: '1f', url: '/lovable-uploads/27ec6583-00c5-4c9f-bf57-429e50240830.png', useForAI: false },
        { id: '1g', url: '/lovable-uploads/cd305798-ab49-4a3b-9157-fb8db777bd8f.png', useForAI: true },
        { id: '1h', url: '/lovable-uploads/c3abfafa-8986-4b30-bd89-3d163701cb64.png', useForAI: false },
        { id: '1i', url: '/lovable-uploads/52231a31-d92b-4dc7-ab75-1e37c3104e6c.png', useForAI: false },
        { id: '1j', url: '/lovable-uploads/e42df4f6-4752-4442-9e7c-06e8184162be.png', useForAI: true },
        { id: '1k', url: '/lovable-uploads/c9668ac2-5bda-49b2-9679-1759280598e1.png', useForAI: false },
        { id: '1l', url: '/lovable-uploads/8a246750-c18b-4b1c-b6af-25185e84d3d7.png', useForAI: false },
        { id: '1m', url: '/lovable-uploads/5557d546-574f-45fb-bd5a-014ec53e5792.png', useForAI: true },
        { id: '1n', url: '/lovable-uploads/42d61632-8522-4f3e-9f7f-712379b47422.png', useForAI: false }
      ]
    },
    {
      id: '3',
    ...
    },
    {
      ...
      status: 'Listed',
      location: 'Denmark',
      description: 'Aviation chronograph with slide rule bezel. Complete set with box and papers.',
      notes: 'VIP customer interested',
      aiInstructions: 'Check bezel operation and chronograph accuracy.',
      images: [
        { id: '4', url: '/lovable-uploads/8a246750-c18b-4b1c-b6af-25185e84d3d7.png', useForAI: true },
        { id: '4a', url: '/lovable-uploads/5557d546-574f-45fb-bd5a-014ec53e5792.png', useForAI: false }
      ]
    },
    {
      id: '6',
      ...
      status: 'Sold',
      location: 'In Transit',
      description: 'Military-inspired pilot watch with antimagnetic movement.',
    ...
    },
    {
      ...
      status: 'Reserved',
      location: 'Vietnam',
      description: 'Spring Drive movement with power reserve indicator. Snowflake dial.',
      notes: 'Reserved for walk-in customer',
      aiInstructions: 'Check power reserve function and dial finishing.',
      images: [
        { id: '6', url: '/lovable-uploads/0884f9b0-c02c-4735-9af7-ebe16f554fe8.png', useForAI: true },
        { id: '6a', url: '/lovable-uploads/27ec6583-00c5-4c9f-bf57-429e50240830.png', useForAI: false }
      ]
    },
    {
      id: '8',
      ...
      location: 'Japan',
      description: 'Vintage-inspired diver with in-house movement. Excellent condition.',
      notes: 'Featured in newsletter',
      aiInstructions: 'Analyze bezel action and case preservation.',
      images: [
        { id: '7', url: '/lovable-uploads/cd305798-ab49-4a3b-9157-fb8db777bd8f.png', useForAI: true }
      ]
    },
    {
      id: '9',
      ...
      status: 'Draft',
      location: 'Denmark',
      description: 'Classic rectangular dress watch with Roman numerals. Steel case.',
      notes: 'Display case featured item',
      aiInstructions: 'Check case polish and crown operation.',
      images: [
        { id: '8', url: '/lovable-uploads/c3abfafa-8986-4b30-bd89-3d163701cb64.png', useForAI: true },
        { id: '8a', url: '/lovable-uploads/52231a31-d92b-4dc7-ab75-1e37c3104e6c.png', useForAI: false }
      ]
    },
    {
      id: '10',
      ...
      status: 'Listed',
      location: 'Vietnam',
      description: 'Elegant dress watch with moon phase complication. Automatic movement.',
      notes: 'Recently polished',
      aiInstructions: 'Focus on moon phase accuracy and case finish.',
      images: [
        { id: '9', url: '/lovable-uploads/e42df4f6-4752-4442-9e7c-06e8184162be.png', useForAI: true }
      ]
    },
    {
      id: '11',
      ...
      status: 'Ready for listing',
      location: 'Japan',
      description: 'Professional diving watch with helium escape valve. Blue ceramic bezel.',
      notes: 'Complete with warranty card',
      aiInstructions: 'Check bezel operation and water resistance seals.',
      images: [
        { id: '10', url: '/lovable-uploads/c9668ac2-5bda-49b2-9679-1759280598e1.png', useForAI: true }
      ]
    },
    {
      id: '12',
      ...
      status: 'Listed',
      location: 'Denmark',
      description: 'Solar-powered diving watch with 200m water resistance. Silicone strap.',
      notes: 'Popular entry-level model',
      aiInstructions: 'Test solar charging function and check bezel alignment.',
      images: [
        { id: '11', url: '/lovable-uploads/8a246750-c18b-4b1c-baf-25185e84d3d7.png', useForAI: false }
      ]
    },
    {
      id: '13',
      ...
      status: 'Review',
      location: 'Vietnam',
      description: 'Sports diving watch with ceramic bezel. 300m water resistance.',
      notes: 'Minor bracelet stretch',
      aiInstructions: 'Examine bracelet condition and crown threading.',
      images: [
        { id: '12', url: '/lovable-uploads/5557d546-574f-45fb-bd5a-014ec53e5792.png', useForAI: true }
      ]
    },
    {
      id: '14',
      ...
      status: 'Sold',
      location: 'In Transit',
      description: 'Luxury dress watch with Co-Axial movement. 18k gold bezel.',
      notes: 'Sold to collector',
      aiInstructions: 'Check gold bezel for scratches and movement accuracy.',
      images: [
        { id: '13', url: '/lovable-uploads/42d61632-8522-4f3e-9f7f-712379b47422.png', useForAI: false }
      ]
    },
    {
      id: '15',
      ...
      status: 'Draft',
      location: 'Japan',
      description: 'Entry-level automatic sports watch. Day-date function.',
      notes: 'Great starter watch',
      aiInstructions: 'Test automatic winding and date change function.',
      images: [
        { id: '14', url: '/lovable-uploads/0884f9b0-c02c-4735-9af7-ebe16f554fe8.png', useForAI: true }
      ]
    },
    {
      id: '16',
      ...
      status: 'Platform Review',
      location: 'Denmark',
      description: 'COSC-certified chronometer with aviation heritage. Titanium case.',
      notes: 'Limited availability model',
      aiInstructions: 'Verify chronometer certification and case condition.',
      images: [
        { id: '15', url: '/lovable-uploads/27ec6583-00c5-4c9f-bf57-429e50240830.png', useForAI: true }
      ]
    },
    {
      id: '17',
      ...
      status: 'Reserved',
      location: 'Vietnam',
      description: 'Elegant dress watch with Roman numerals. Leather strap.',
      notes: 'Customer deposit received',
      aiInstructions: 'Check dial condition and leather strap wear.',
      images: [
        { id: '16', url: '/lovable-uploads/cd305798-ab49-4a3b-9157-fb8db777bd8f.png', useForAI: false }
      ]
    },
    {
      id: '18',
      ...
      status: 'Standby',
      location: 'Japan',
      description: 'Distinctive angular case diver with 200m water resistance.',
      notes: 'Awaiting photography',
      aiInstructions: 'Test bezel action and check crown seal.',
      images: [
        { id: '17', url: '/lovable-uploads/c3abfafa-8986-4b30-bd89-3d163701cb64.png', useForAI: true }
      ]
    },
    {
      id: '19',
      ...
      location: 'Denmark',
      description: 'Vintage-inspired dress watch with sector dial. Needs service.',
      notes: 'Crown issue - service required',
      aiInstructions: 'Document crown problem and overall condition.',
      images: [
        { id: '18', url: '/lovable-uploads/52231a31-d92b-4dc7-ab75-1e37c3104e6c.png', useForAI: true }
      ]
    }
  ]);
  ...
  const handleSaveWatch = (watchData: Omit<Watch, 'id'>) => {
    if (editingWatch) {
      setWatches(watches.map(w => w.id === editingWatch.id ? { ...watchData, id: editingWatch.id } : w));
    } else {
  ...
  const filteredAndSortedWatches = useMemo(() => {
    let filtered = watches.filter(watch => {
      const matchesStatus = statusFilters.includes('All') || statusFilters.includes(watch.status);
    ...
    return filtered;
  }, [watches, statusFilters, brandFilter, batchFilter, locationFilter, searchTerm, sortField, sortDirection]);

  const paginatedWatches = useMemo(() => {
    const startIndex = (currentPage - 1) * itemsPerPage;
    return filteredAndSortedWatches.slice(startIndex, startIndex + itemsPerPage);
  ...
  const uniqueBrands = ['All', ...Array.from(new Set(watches.map(w => w.brand).filter(brand => brand && brand.trim() !== '')))];
  const uniqueBatches = ['All', ...Array.from(new Set(watches.map(w => getBatchGroup(w.id))))];
  const uniqueLocations = ['All', ...Array.from(new Set(watches.map(w => w.location).filter(location => location && location.trim() !== '')))];
  ...
  const firstRowStatuses = ['All', 'Draft', 'Review', 'Approved', 'Platform Review', 'Ready for listing'];
  const secondRowStatuses = ['Listed', 'Reserved', 'Sold', 'Defect/Problem', 'Standby'];
  ...
  const handleEditBatches = () => {
    alert('Batch editing feature would be implemented here. This would open a modal to add, edit, or remove batch groups from the list.');
  };
  ...
  const handlePreviousWatch = () => {
    if (editingWatch) {
      const currentIndex = filteredAndSortedWatches.findIndex(w => w.id === editingWatch.id);
      if (currentIndex > 0) {
        const previousWatch = filteredAndSortedWatches[currentIndex - 1];
      ...
      <div className="p-8">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-slate-600 mt-1">Manage your watch inventory and track status</p>
            </div>
            <div className="flex gap-4">
              <div className="flex border border-slate-300 rounded-lg h-[42px]">
                <Button
          ...
          <div className="flex flex-col lg:flex-row gap-4 mb-6">
            ...
            <div className="flex gap-4 items-center">
              <div className="flex items-center gap-2">
                <span className="text-sm font-medium text-slate-700 whitespace-nowrap">Brand:</span>
                <BrandSelector
                  value={brandFilter}
                  onValueChange={(value) => {
              ...
              <div className="flex items-center gap-2">
                <span className="text-sm font-medium text-slate-700 whitespace-nowrap">Batch:</span>
                <BatchSelector
                  value={batchFilter}
                  onValueChange={(value) => {
          ...
          <div className="flex justify-between items-center mb-4">
            <div className="text-sm text-slate-600">
              Showing {((currentPage - 1) * itemsPerPage) + 1}-{Math.min(currentPage * itemsPerPage, filteredAndSortedWatches.length)} of {filteredAndSortedWatches.length} watches
            </div>
            {totalPages > 1 && (
        ...
        {showForm && (
          <WatchForm
            ...
            onNext={getNavigationInfo().hasNext ? handleNextWatch : undefined}
            onPrevious={getNavigationInfo().hasPrevious ? handlePreviousWatch : undefined}
