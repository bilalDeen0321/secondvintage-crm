                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Upload multiple watches at once using CSV or
                                text format
                            </CardDescription>
                        </CardHeader>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Export watch data in various formats
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Resize and optimize watch images
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Generate shipping labels for packages
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div>
