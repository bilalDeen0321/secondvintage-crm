...
const sampleWatches: SellerWatch[] = [
  {
    ...
    images: [{ id: '1', url: '/lovable-uploads/6902d75d-7bb8-43ee-93eb-56d642c25393.png', useForAI: false }],
    status: 'Unpaid',
  ...
  },
  {
    ...
    images: [{ id: '2', url: '/lovable-uploads/a8c00d5a-b861-49cb-a3f7-d2cb8ef864de.png', useForAI: false }],
    status: 'Paid',
  ...
  },
  {
    ...
    images: [{ id: '3', url: '/lovable-uploads/0464203d-f5d6-4f95-8d96-7ac6a8a62fba.png', useForAI: false }],
    status: 'Unpaid',
  ...
  },
  {
    ...
    images: [{ id: '4', url: '/lovable-uploads/602bc27c-db31-4f3f-8174-9217172c4867.png', useForAI: false }],
    status: 'Paid',
  ...
  },
  {
    ...
    images: [{ id: '5', url: '/lovable-uploads/1f4e1ffe-7868-4e62-bbbe-9b6aba3835d7.png', useForAI: false }],
    status: 'Unpaid',
...
const Sellers = () => {
  ...
  const [selectedWatch, setSelectedWatch] = useState<SellerWatch | null>(null);
            ...
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <Label>Images</Label>
                  <div className="mt-2">
                    <ImageManager images={formImages} onChange={setFormImages} />
                  </div>
                </div>
          ...
          <CardContent>
            <div className="grid grid-cols-4 gap-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-slate-900">{watches.length}</div>
                <div className="text-sm text-slate-600">Total Watches</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-yellow-600">
                  {watches.filter(w => w.status === 'Unpaid').length}
                </div>
                <div className="text-sm text-slate-600">Unpaid</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600">
                  {watches.filter(w => w.status === 'Paid').length}
                </div>
                <div className="text-sm text-slate-600">Paid</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600">
                  <CurrencyDisplay euroAmount={totalOutstanding} />
                </div>
                <div className="text-sm text-slate-600">Outstanding Amount</div>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  className={statusFilter === 'Unpaid' ? 'bg-yellow-600 hover:bg-yellow-700' : 'border-yellow-300 text-yellow-700 hover:bg-yellow-50'}
                >
                  Unpaid ({watches.filter(w => w.status === 'Unpaid').length})
                </Button>
                <Button
                ...
                >
                  Paid ({watches.filter(w => w.status === 'Paid').length})
                </Button>
              </div>
            </div>
          </CardContent>
            ...
            <CardTitle>
              ...
              {statusFilter !== 'All' && (
                <span className="ml-2 text-base font-normal text-slate-600">
                  - Showing {statusFilter} ({filteredAndSortedWatches.length})
                </span>
              )}
            </CardTitle>
          </CardHeader>
              ...
              <TableBody>
                {filteredAndSortedWatches.map((watch) => (
                  <TableRow key={watch.id}>
                    ...
                    <TableCell>
                      {watch.currency === 'EUR' ? (
                        <CurrencyDisplay euroAmount={watch.price} />
                      ) : (
                    ...
                    <TableCell>
                      <div className="flex gap-2">
                        <Button variant="outline" size="sm" onClick={() => handleEditWatch(watch)}>
