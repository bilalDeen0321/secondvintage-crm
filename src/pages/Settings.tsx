              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input id="company-name" defaultValue="Second Vintage" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="company-email">Company Email</Label>
                    <Input id="company-email" type="email" defaultValue="info@secondvintage.com" />
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mb-4">Choose a color theme for your application</p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="sales-notifications">New sales and orders</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Switch id="inventory-notifications" defaultChecked />
                      <Label htmlFor="inventory-notifications">Low inventory alerts</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Switch id="payment-notifications" defaultChecked />
                      <Label htmlFor="payment-notifications">Payment confirmations</Label>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 border rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Sync listings and sales data</p>
                    </div>
                    <Badge className="bg-green-100 text-green-800">Connected</Badge>
                  </div>
                  <div className="flex items-center justify-between p-4 border rounded-lg">
                    <div>
                      <h3 className="font-medium">Chrono24 API</h3>
                      <p className="text-sm text-muted-foreground">Import watch listings</p>
                    </div>
