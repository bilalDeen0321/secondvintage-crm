...
const VendorPayments = () => {
    ...
    const [isAddWatchToEditDialogOpen, setIsAddWatchToEditDialogOpen] =
        useState(false);
    const [selectedPaymentForDraft, setSelectedPaymentForDraft] =
        useState<Payment | null>(null);

    // Payment table sorting
    const [paymentSortField, setPaymentSortField] =
        useState<keyof Payment>("date");
    const [paymentSortDirection, setPaymentSortDirection] = useState<
        "asc" | "desc"
    >("desc");

    // Payment items sorting for edit dialog
    const [paymentItemsSortField, setPaymentItemsSortField] =
        useState<keyof PaymentItem>("name");
    const [paymentItemsSortDirection, setPaymentItemsSortDirection] = useState<
        "asc" | "desc"
    >("asc");
    ...
    const [payments, setPayments] = useState<Payment[]>([
        ...
        },
        {
            ...
            quantity: 4,
            description:
                "Cartier collection - Tank, Santos, Ballon Bleu, Calibre",
            amount: 20000,
            status: "Refunded",
            currency: "EUR",
            date: "2024-01-10",
        ...
        },
        {
            ...
            quantity: 2,
            description:
                "Omega Speedmaster Professional, Seamaster Planet Ocean",
            amount: 18000,
            status: "Paid (received)",
            currency: "USD",
            date: "2024-02-01",
    ...
    const filteredPayments = payments.filter((payment) => {
        ...
        const matchesSeller =
            sellerFilter === "all" || payment.seller === sellerFilter;
        const matchesAgent =
            agentFilter === "all" || payment.agent === agentFilter;
    ...
    const paymentTotalPages = Math.ceil(
        sortedPayments.length / paymentPageSize,
    );
    ...
    const handlePaymentItemsSort = (field: keyof PaymentItem) => {
        if (paymentItemsSortField === field) {
            setPaymentItemsSortDirection(
                paymentItemsSortDirection === "asc" ? "desc" : "asc",
            );
        } else {
    ...
    const calculateLocalCurrency = (
        ...
        if (agent.localCurrency === "VND")
            return usdAmount * agent.exchangeRate;
        if (agent.localCurrency === "JPY")
            return usdAmount * agent.exchangeRate;
        return euroAmount;
    };
    ...
    const handlePaymentItemStatusChange = (
        itemId: string,
        newStatus:
            | "Unpaid"
            | "Paid (not received)"
    ...
    const uniqueSellers = [
        ...new Set(payments.map((payment) => payment.seller)),
    ];
    ...
    const handleCreatePayment = () => {
        ...
        const selectedAgentData = agentBalances.find(
        ...
        const newPayment: Payment = {
            ...
            description:
                paymentDescription ||
                `Payment for ${paymentItems.length} items`,
            ...
            <div className="space-y-6 p-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Manage agent payments and balances
                        </p>
                    </div>
                    <div className="flex space-x-2">
                        <Dialog
                            open={isNewDepositDialogOpen}
                            onOpenChange={setIsNewDepositDialogOpen}
                        >
                            ...
                            <DialogContent className="max-h-[90vh] max-w-4xl overflow-y-auto">
                                <DialogHeader>
                                    ...
                                    <DialogDescription>
                                        Record a new deposit from an agent.
                                    </DialogDescription>
                                </DialogHeader>
                        ...
                        >
                            ...
                            <DialogContent className="max-h-[90vh] max-w-5xl overflow-y-auto">
                                <DialogHeader>
                                    ...
                                    <DialogDescription>
                                        Record a new payment to an agent.
                                    </DialogDescription>
                                </DialogHeader>
                            ...
                            <CardContent>
                                ...
                                <Table>
                                    ...
                                    <TableBody>
                                        {paginatedPayments.map((payment) => {
                                            const agent = agentBalances.find(
                                                (a) => a.id === payment.agentId,
                                            );
                                            return (
                                ...
                                <div className="flex items-center justify-between space-x-2 py-4">
                                    <div className="text-sm text-muted-foreground">
                                        ...
                                        of {sortedPayments.length} entries
                                    </div>
                                    <Pagination>
                                        <PaginationContent>
                                            <PaginationItem>
                            ...
                            <CardContent>
                                <div className="mb-4 flex items-center justify-between">
                                    <div className="flex items-center space-x-2">
                                        <Select
                                            value={depositPageSize.toString()}
                                            onValueChange={(value) =>
                                                setDepositPageSize(
                                                    Number(value),
                                                )
                ...
                >
                    <DialogContent className="max-h-[90vh] max-w-7xl overflow-y-auto">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="text-xs text-slate-500">
                                Created by {editingPayment?.createdBy} on{" "}
                                {editingPayment &&
                                    format(
                                        new Date(editingPayment.createdDate),
                                        "MMM dd, yyyy",
                                    )}
                            </div>
                            <DialogFooter>
