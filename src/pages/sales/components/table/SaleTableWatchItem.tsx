...
export default function SaleTableWatchItem({
    onOpenSingleView,
    onSelectWatch,
    onViewPlatformData,
    processingWatches,
    ...
    return (
        <tr
            ...
            className={`hover:bg-slate-50 ${
                selectedWatches.includes(String(watch.id)) ? "bg-amber-50" : ""
            }`}
        >
            <td className="p-3">
                <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                        onSelectWatch(String(watch.id), checked as boolean)
                    }
                />
            </td>
            <td className="p-3">
            ...
            <TablePlatformSelectItem
                watch={watch}
                value={platform}
                onValueChange={onPlatformChange}
            />

            <SaleTablePlatformItem
